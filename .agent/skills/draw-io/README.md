...
bash ~/.agent/skills/draw-io/scripts/convert-drawio-to-png.sh assets/diagram.drawio
```
...
```bash
python ~/.agent/skills/draw-io/scripts/find_aws_icon.py ec2
python ~/.agent/skills/draw-io/scripts/find_aws_icon.py lambda
```
